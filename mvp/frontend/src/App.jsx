...
import { Home, Calendar, Users, Settings, UserPlus, DollarSign, BarChart2, LogOut, Menu, X, UserCircle, ChevronLeft, ChevronRight, Car, BoxIcon, FileText, Database } from 'lucide-react'; // Adicionado ChevronLeft e ChevronRight
        ...
        <aside className={`sidebar ${isMobileSidebarOpen ? 'open' : ''} ${isDesktopSidebarCollapsed ? 'collapsed' : ''}`}>
            ...
            <nav className="sidebar-nav">
                ...
                {(userRole === 'admin' || userRole === 'gerente') && (
                 <Link to="/cadastros/clientes" className={`sidebar-nav-item ${location.pathname.startsWith('/cadastros') ? 'active' : ''}`} onClick={toggleSidebar}>
            ...
            <Route
                ...
                element={
                    <PrivateRoute requiredRoles={['admin', 'gerente', 'atendente']}>
                        <AppLayout><CadastrosPage /></AppLayout>
                    </PrivateRoute>
                }
            />
            <Route
